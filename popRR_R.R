...
winSize = as.integer(args[2]) # genomic window size to work on
Popsize = read.table(args[3], header = F) # path to text file with info

screen = paste("You specifized the vcf file to be located in",input, ".\n The windowsize was set to",  winSize, "MB.\n", "The population size will be derived from", Popsize)
